...
# annot_path = './data/test.txt'
annot_path = './val.txt'
CURRENT_KNOWN_OBJECTS = EVALUATION_CLASSES = './custom_data/pascal_voc07_cls_names.txt'
...
# yolo.load_weights('./checkpoints/yolov3_normal_val_loss_ 113.92')
yolo.load_weights('./checkpoints/yolov3_normal_val_loss_  18.42')
