...
CLASSES_TO_EVALUATE = './data/current_objects.txt'
...
yolo.load_weights('./checkpoints/yolov3_custom_val_loss_  99.94')
...
for i in range(1):
	...
	print('Overall_recall :{:7.3f}, Overall_precision : {:7.3f}, Overall_mAP : {:7.3f}'.format(t_recall/count, 
